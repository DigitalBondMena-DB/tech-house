...
import { AfterViewInit, ChangeDetectorRef, Component, computed, effect, ElementRef, inject, OnInit, PLATFORM_ID, signal, viewChild } from '@angular/core';
...
export class Home implements OnInit {
      ...
      effect(()=>{
        ...
        if(!this.isSmallScreen()) {
          ...
          this.videoRef()?.nativeElement.play().catch((e)=>{
            console.error("when play video",e);
          })
        }
      })
      effect(() => {
  ...
  private screenWidth = signal<number>(1920);
